...
$STUDIO_URL = 'https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2022.3.1.18/android-studio-2022.3.1.19-windows.zip' # https://developer.android.com/studio
...
$ANDROID_SDK_MANAGER = 'https://dl.google.com/android/repository/commandlinetools-win-10406996_latest.zip' # https://developer.android.com/studio#command-tools
...
$FLUTTER_SDK = 'https://storage.googleapis.com/flutter_infra_release/releases/stable/windows/flutter_windows_3.13.1-stable.zip' # https://docs.flutter.dev/get-started/install/windows
